...
function About() {
    return (
        <div className="container">
            ...
            <p>Track your English words to increase your vocabulary and improve your communication skills. For example, before going to the bank, review the bank subject so you're familiar with words associated with banking. Then you'll be prepared to clearly communicate your banking needs.</p>
            <ul>
